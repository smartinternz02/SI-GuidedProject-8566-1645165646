...
API_KEY = "1j2VHzrRkhWntwnK53ly_sMsz51sNFKCnMOory7v__hT"
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/aeb9cb16-4e48-42aa-acc3-f8407e255fe6/predictions?version=2022-03-06', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
