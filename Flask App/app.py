...
app = Flask(__name__)
model = pickle.load(open('C:\\Users\\dell\\Desktop\\project\\Predictive Modeling For H1B Visa Approval Using IBM Watson\\Predictive Modeling For H1B Visa Approval Using IBM Watson\\VisaApprovalPrediction-main\\Flask App\\Visarf.pkl', 'rb'))
